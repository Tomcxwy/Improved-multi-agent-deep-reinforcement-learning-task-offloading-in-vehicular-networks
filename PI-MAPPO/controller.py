...
class Controller:
    ...
    def visualize(self):
        ...
        # ax1.set_title("Joint Reward 联合奖励", fontsize = 18)
        ...
        # ax2.set_title("Device Reward 设备个体奖励", fontsize = 18)
        ...
        # ax3.set_title("Joint Cost 联合成本", fontsize = 18)
        ...
        # ax4.set_title("Device Cost 设备的个体成本", fontsize = 18)
        ...
        # ax5.set_title("Edge Computation-Queue Length (Gcycles) 边缘服务器任务队列长度，单位 Gcycles", fontsize = 18)
        ...
        # ax6.set_title("Device Computation-Queue Length (Gcycles) 本地设备任务队列长度，单位 Gcycles", fontsize = 18)
        ax6.tick_params(axis = 'both', labelsize = 18)
        

        # device computation-delay
        fig7 = plt.figure(figsize = (12, 8))
        ax7 = fig7.add_subplot(1, 1, 1)
        # y = [episode_num, device_num]
        y = np.array(self.device_comp_dlys_col)
        for i in range(self.device_num):
            ax7.plot(x, y[:, i], marker = ".", linewidth = 3)
        ax7.grid(True)
        ax7.set_xlabel(xlabel = "Episodes", fontsize = 18)
        ax7.set_ylabel(ylabel = "Task Computation-Delay (s)", fontsize = 18)
        # ax7.set_title("Task Computation-Delay (ms) 设备任务计算延迟，单位 s", fontsize = 18)
        ...
        # ax8.set_title("Task Energy-Consumption (mJ) 任务能耗，单位 mJ", fontsize = 18)
        ...
        # ax9.set_title("Task Computation-Expense 设备计算开销/费用", fontsize = 18)
        ...
        # ax10.set_title("Device Overtime-Number 设备任务超时次数", fontsize = 18)
